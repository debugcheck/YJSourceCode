...
@interface NOrderListViewController : PageRefreshTableViewController<NOrderListServiceDelegate,ServiceDetailServiceDelegate,SecondPayServiceDelegate,OrderDetailServiceDelegate,OrderSelectDownDelegate>{
