...
<OrderDetailServiceDelegate,ProductDetailSubmitServiceDelegate,SecondPayServiceDelegate,NewOrderStatusCellDelegate,NewEvalutionServiceDelegate,EGOImageViewExDelegate>
{
