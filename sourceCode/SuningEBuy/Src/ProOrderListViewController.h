...
@interface ProOrderListViewController : AllOrderListPageFreshViewController<NOrderListServiceDelegate,SecondPayServiceDelegate,ServiceDetailServiceDelegate,OrderDetailServiceDelegate,NewEvalutionServiceDelegate,ProductDetailSubmitServiceDelegate>
{
    BOOL isReturnStatus;
